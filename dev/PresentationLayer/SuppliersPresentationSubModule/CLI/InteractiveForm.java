...
public abstract class InteractiveForm<T> {
    ...
    protected HashMap<Integer, Integer> askForOrderProducts(HashMap<Integer, Integer> existingProds)
            throws Cancelled {
        ...
        while (true) {
            ...
            if (action.equals("done")) {
                if (products.isEmpty()) {
                    view.showError("No products added to the order. Please add products before finishing.");
                    continue;
                }
                return products;
            }
