...
import PresentationLayer.SuppliersPresentationSubModule.CLI.Forms.OrderForm;
...
public class CreateOrderCMD implements CommandInterface {
    ...
    public CreateOrderCMD(View view, OrderService orderService, SupplierService supplierService) {
        this.view = view;
    ...
    public void execute() {
        ...
        if (products.isEmpty()) {
            view.showError("No products available in the catalog. Please add products before creating an order.");
            return;
        }
