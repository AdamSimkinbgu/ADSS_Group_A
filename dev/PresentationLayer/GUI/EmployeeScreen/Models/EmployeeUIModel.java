package PresentationLayer.GUI.EmployeeScreen.Models;
...
public class EmployeeUIModel {
    ...
    public long getIsraeliId() {
        return israeliId.get();
    }

    public void setIsraeliId(long id) {
        israeliId.set(id);
    }

    public LongProperty israeliIdProperty() {
        return israeliId;
    }
    ...
    public LongProperty branchIdProperty() {
        return branchId;
    }
