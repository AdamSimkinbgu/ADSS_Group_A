...
public class AvailabilityController {
    ...
    private void loadBranches() {
        try {
            ...
            // Add branches from service (this is a placeholder - actual implementation would get branches from service)
    ...
    /**
     * Creates the calendar grid with days of the week as columns and shift types as rows.
     */
    ...
    private void refreshCalendar() {
        try {
            ...
            // For example: Set<ShiftDTO> shifts = shiftService.getShiftsByWeek(currentEmployeeId, new Week(currentWeekStart));
    ...
    private StackPane createShiftCell(ShiftData shift) {
        ...
        cell.setOnMouseClicked(e -> {
            if (e.getButton() == MouseButton.PRIMARY) {
                // Left click - toggle availability (once for available, twice for not available)
    ...
    public void saveAvailability() {
        ...
        try {
            ...
            if (failCount == 0) {
                ...
                showWarning("Partial Success", "Saved availability for " + successCount + " shifts, but failed for " + failCount + " shifts");
            }
    ...
    private boolean isEmployeeAvailable(ShiftData shift) {
        // This is a placeholder - actual implementation would check if the employee is available
        // For example: return shiftService.isEmployeeAvailable(currentEmployeeId, Long.parseLong(shift.getId()), currentEmployeeId);
    ...
    private void selectShift(ShiftData shift) {
        ...
        selectedShiftLabel.setText(shift.getType() + " Shift on " + shift.getDate().format(DateTimeFormatter.ofPattern("EEEE, MMMM d, yyyy")));
