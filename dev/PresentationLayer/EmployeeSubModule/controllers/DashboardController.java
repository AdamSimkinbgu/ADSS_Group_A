...
public class DashboardController {
    ...
    private void loadStatistics() {
        try {
            ...
            for (String employeeJson : employeeData) {
                ...
                // This is a simplified approach - in a real implementation, we would parse the JSON properly
    ...
    private void loadCharts() {
        try {
            ...
            for (String day : daysOfWeek) {
                ...
                // This is a very rough approximation - in a real implementation, we would parse the JSON properly
                int count = 0;
                int index = 0;
                ...
                // In a real implementation, we would count the actual number of employees assigned to each shift
                if (count > 0) {
    ...
    private void loadRecentActivity() {
        try {
            ...
            Arrays.sort(employeeData, (e1, e2) -> {
                ...
                // For simplicity, we'll just compare the length of the JSON as a proxy for recency
            ...
            // This is a simplified approach - in a real implementation, we would sort by date
    ...
    private void loadMockActivityData() {
        ObservableList<ActivityEntry> activityData = FXCollections.observableArrayList(
            new ActivityEntry(LocalDateTime.now().minusDays(1), "Employee", "Added new employee: John Doe", "Admin"),
            new ActivityEntry(LocalDateTime.now().minusDays(2), "Shift", "Created shift for Monday morning", "Manager"),
            ...
            new ActivityEntry(LocalDateTime.now().minusDays(5), "Shift", "Assigned 5 employees to shift", "Manager")
        );
