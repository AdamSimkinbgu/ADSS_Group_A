...
//         main.AddProduct("Cheese", "Tnuva", 0, 0, 6.0f,
//                 new Position(1, 1), new Position(2, 2));
//         String report = main.GetMissingReport();
...
//                 new Position(1, 1), new Position(2, 2));
//         main.AddProduct(p);
//         DiscountDTO d = new DiscountDTO("Summer Sale", 0.1f, LocalDate.now(), LocalDate.now().plusDays(7), 10);
//         d.setpId(10);
...
//         DiscountDTO d = new DiscountDTO("Snack Discount", 0.2f, LocalDate.now(), LocalDate.now().plusDays(5), 5);
//         d.setCatName("Snacks");
//         assertDoesNotThrow(() -> main.AddDiscount(d));
//     }
...
//                 new Position(1, 1), new Position(2, 2));
//         main.AddProduct(p);
//         DiscountDTO d = new DiscountDTO("Chips Discount", 0.5f, LocalDate.now(), LocalDate.now().plusDays(2), 1);
//         d.setpId(11);
//         main.AddDiscount(d);
...
//         assertDoesNotThrow(() -> main.InventoryInitialization(InitializeState.DEFAULT_STATE));
...
//         ProductDTO p2 = new ProductDTO(101, "Honey", "BrandB", 10, 20, 7.0f, new Position(1, 1), new Position(2, 2));
//         main.AddProduct(p1);
