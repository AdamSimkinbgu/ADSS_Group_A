...
class JdbcPeriodicOrderDAOTest {
   ...
   // PeriodicOrderDTO fetched =
   // dao.getPeriodicOrder(created.getPeriodicOrderID());
   ...
   // new HashMap<>(),
   // true);
   // assertThrows(DataAccessException.class, () -> dao.createPeriodicOrder(bad),
   // "Invalid day mask (null or wrong format) should violate CHECK and throw
   // SQLException");
   // }
}