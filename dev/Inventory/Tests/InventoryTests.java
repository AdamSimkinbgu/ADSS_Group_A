...
// ProductDTO p = new ProductDTO(8,"Bread", "Angel", 10, 20, 5.5f, new
// Position(1, 2), new Position(3, 4))
// main.AddProduct(p);
...
// ProductDTO p = new ProductDTO(7,"Bread", "Angel", 10, 20, 5.5f, new
// Position(1, 2), new Position(3, 4))
// main.AddProduct(p);
...
// ProductDTO p = new ProductDTO(1,"Butter", "Tnuva", 2, 2, 7.0f, new
...
// main.AddProduct("Yogurt", "Tara", 10, 10, 4.5f, new Position(1,1), new
// Position(2,2));
...
// main.AddProduct("Eggs", "Local", 10, 10, 12.0f, new Position(1,1), new
// Position(2,2));
...
// main.AddProduct("Tomato", "Farm", 5, 5, 3.0f, new Position(0,0), new
// Position(1,1));
...
// main.AddProduct("Cucumber", "Farm", 5, 5, 2.5f, new Position(1,1), new
// Position(2,2));
...
// main.AddProduct("Apple", "Farm", 5, 5, 2.5f, new Position(1,1), new
// Position(2,2));
