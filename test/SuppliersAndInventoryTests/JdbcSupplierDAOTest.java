...
class JdbcSupplierDAOTest {
      ...
      void insertAndFetchSupplier_roundTrip() {
            ...
            SupplierDTO dto = new SupplierDTO(
                        ...
                        /* name = */ "Acme Corp",
                        /* tax = */ "123456789",
                        /* address = */ new DTOs.SuppliersModuleDTOs.AddressDTO("1 Main St", "Metropolis", "12345"),
                        /* selfSupply = */ true,
                        ...
                        /* contacts= */ List
                                    .of(new DTOs.SuppliersModuleDTOs.ContactInfoDTO("Alice", "alice@example.com",
                                                "555-0001")));
      ...
      void insertingDuplicateTaxNumber_throwsDataAccessException() {
            SupplierDTO dto1 = new SupplierDTO(
                        -1, "Supplier A", "TAX123",
                        new DTOs.SuppliersModuleDTOs.AddressDTO("Street", "City", "1"),
                        false, java.util.EnumSet.noneOf(java.time.DayOfWeek.class),
                        0,
                        new DTOs.SuppliersModuleDTOs.PaymentDetailsDTO("415236", PaymentMethod.valueOf("CASH"),
            ...
            SupplierDTO dto2 = new SupplierDTO(
                        -1, "Supplier B", "TAX123",
                        new DTOs.SuppliersModuleDTOs.AddressDTO("Road", "Town", "2"),
                        true, java.util.EnumSet.noneOf(java.time.DayOfWeek.class),
                        1,
                        new DTOs.SuppliersModuleDTOs.PaymentDetailsDTO("415236", PaymentMethod.valueOf("CREDIT_CARD"),
