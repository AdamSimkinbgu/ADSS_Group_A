...
class SupplierUnitTests {
      ...
      void setUp() {
            ...
            SupplierDTO dto = new SupplierDTO(
                        ...
                        /* leadDays = */ 2,
                        /* payment = */ new PaymentDetailsDTO("111-222-333", PaymentMethod.BANK_TRANSFER,
                                    PaymentTerm.N30),
      ...
      void setProductNameAndCategoryForOrderItems_happyPath() {
            ...
            SupplierProductDTO p1 = new SupplierProductDTO(
                        seedSupplier.getId(), -1, "CAT-300", "AlphaWidget", new BigDecimal("5.0"),
                        new BigDecimal("0.5"), 15,
                        "MakerA");
            SupplierProductDTO p2 = new SupplierProductDTO(
                        seedSupplier.getId(), -1, "CAT-400", "BetaGadget", new BigDecimal("8.0"), new BigDecimal("1.0"),
                        20,
                        "MakerB");
            ...
            // Act
            List<OrderItemLineDTO> populated = facade.setProductNameAndCategoryForOrderItems(input,
                        seedSupplier.getId());
      ...
      void setSupplierPricesAndDiscountsByBestPrice_happyPath() {
            ...
            SupplierProductDTO p = new SupplierProductDTO(
                        seedSupplier.getId(), -1, "CAT-500", "GammaWidget", new BigDecimal("10.00"),
                        new BigDecimal("1"), 30,
                        "MakerC");
            facade.addProductToSupplierAndMemory(seedSupplier.getId(), p);
      ...
      void setSupplierPricesAndDiscountsByBestPrice_nullOrBadInput_throws() {
            ...
            assertThrows(IllegalArgumentException.class,
                        () -> facade.setSupplierPricesAndDiscountsByBestPrice(Collections.emptyList(),
                                    seedSupplier.getId()));
